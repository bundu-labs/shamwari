 ...
 *
 * Framework-agnostic builder functions for Schema.org types used across
 * Shamwari AI properties. Render the resulting object via the
 * `JsonLd.svelte` component (or any equivalent) inside `<svelte:head>`.
 */
